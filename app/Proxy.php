    ...
    public function configurationParameterError()
    {
        ...
        $configError = array(
            "error" => array("code" => 412,
                ...
                "message" => "Proxy failed due to configuration error.".dirname(__FILE__)
            ));
...
class ProxyLog {
    ...
    public function __construct($configuration = null) {
        ...
        $this->proxyDataValid = new \App\DataValidUtil;
    ...
    public function log($message)
    {
        ...
        $message = $this->proxyDataValid->replaceCRLF($message, "__");
        // $message = "Testing";
...
class ProxyConfig {
    ...
    public function useJSON()
    {
        try {
            ...
            $c = file_get_contents(dirname(__FILE__)."/proxy.config");
