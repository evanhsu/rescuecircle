...
<div id="container-fluid" class="container-fluid background-container">
    ...
    <div class="container form-box">
        ...
        <form action="{{ route('create_status') }}" method="POST" class="form-horizontal">
            ...
            <?php
                $freshness = $helicopter->freshness();
                switch($freshness) {
                    case "missing":
                        $alert = array( 'msg'   => "No updates have ever been posted for this Helicopter!",
                                        'type'  => 'warning');
                        break;
                    case "fresh":
                        $alert = array( 'msg'   => "This helicopter's status is still fresh",
                                        'type'  => 'success');
                        break;
                    case "stale":
                        $alert = array( 'msg'   => "This helicopter's status is out of date",
                                        'type'  => 'warning');
                        break;
                    case "expired":
                        $alert = array( 'msg'   => "This helicopter's status is expired!",
                                        'type'  => 'danger');
                        break;
                }
